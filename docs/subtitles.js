...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_parse')) {
        Object.defineProperty(Module['ready'], '_parse', { configurable: true, get: function() { abort('You are getting _parse on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_parse', { configurable: true, set: function() { abort('You are setting _parse on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
function write_sub_entity(str,start,stop){ globalThis.wasm_parsed.data.push({start: start, stop: stop, text: UTF8ToString(str)}); }
function write_type(str){ globalThis.wasm_parsed = {type: UTF8ToString(str), data: []}; }
...
var asmLibraryArg = {
  ...
  "write_sub_entity": write_sub_entity,
...
/** @type {function(...*):?} */
var _parse = Module["_parse"] = createExportWrapper("parse");
