...
var wasmBinaryFile = 'subtitles.wasm';
...
function write_sub_entity(str,start,stop){ if (!window.parsed.data) { window.parsed.data = []; } window.parsed.data.push({start: start, stop: stop, text: UTF8ToString(str)}); }
function write_type(str){ window.parsed = {type: UTF8ToString(str)}; }
...
/** @type {function(...*):?} */
var ___em_js__write_type = Module["___em_js__write_type"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__write_type"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__write_sub_entity = Module["___em_js__write_sub_entity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__write_sub_entity"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _parse = Module["_parse"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["parse"].apply(null, arguments)
};
